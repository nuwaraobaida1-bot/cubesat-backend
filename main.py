...
app = FastAPI(
    ...
    description="Upload PDF or DOCX files, ask questions, and get answers based only on the document.",
    version="1.0.0",
)
...
def ask_groq(prompt: str) -> str:
    if not GROQ_API_KEY:
        raise HTTPException(
            status_code=500,
            detail="GROQ_API_KEY is missing. Add it to your Render environment variables.",
        )
